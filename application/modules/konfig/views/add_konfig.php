				...
				<div class="card">
					<div class="card-body">
						...
						   <form class="forms-sample" method="POST" action="javascript:tambah()" id="form" enctype="multipart/form-data">
							<input type="hidden" value="" name="id_konfig" id="id_konfig"/> 
							...
							<div class="form-group">
								<label>Tgl</label>
								<input type="date" class="form-control" id="tgl" name="tgl" placeholder="Tanggal Pembuatan" value="<?=date('Y-m-d')?>" >
								<small class="help-block text-danger"></small>
							</div>
							<div class="form-group">
								<label>Klien</label>
								<input type="text" class="form-control" id="klien" name="klien" placeholder="Klien"><small class="help-block text-danger"></small>
							</div>
							<div class="form-group">
								<label>Pembuat</label>
								<input type="text" class="form-control" id="pembuat" name="pembuat" placeholder="Pembuat"><small class="help-block text-danger"></small>
							</div>
							<div class="form-group">
								<label>Footer</label>
								<input type="text" class="form-control" id="footer" name="footer" placeholder="Footer"><small class="help-block text-danger"></small>
							</div>
						</form> 
...
function save()
{
    ...
    if(save_method == 'add') {
    	var url = "<?php echo site_url('konfig/ajax_add')?>";
    } else {
    	var url = "<?php echo site_url('konfig/ajax_update')?>";
    }
