				...
				<div class="card">
					<div class="card-body">
						...
						   <form class="forms-sample" method="POST" action="javascript:tambah()" id="form" enctype="multipart/form-data">
							<input type="hidden" value="" name="id_level" id="id_level"/> 
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan"><small class="help-block text-danger"></small>
							</div>
						</form> 
...
function save()
{
    ...
    if(save_method == 'add') {
    	var url = "<?php echo site_url('level/ajax_add')?>";
    } else {
    	var url = "<?php echo site_url('level/ajax_update')?>";
    }
