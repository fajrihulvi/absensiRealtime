...
class M_level extends CI_Model
{
	...
	var $dt_column_order = array(null,'level','direct_link','keterangan'); //set column field database for datatable orderable
	var $dt_column_search = array('level');
     //set column field database for datatable searchable 
	var $dt_order = array('id_level' => 'DESC');
